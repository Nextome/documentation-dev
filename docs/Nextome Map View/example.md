...
=== "Dart"
    ...
    class _ExampleState extends State<Example> {
        ...
        // Define the mapview widget and it's controller
        NMMapView? mapview;
        ...
        NMMapView? buildMapViewWidget(BuildContext context){
            ...
            // Original png image height and width. You must know height and width
            final double mapHeight = 6500;
            ...
            NMTile tile = NMTile(
                ...
                id: '1',
                zindex: 0,
                source: 'ABSOLUTE_PATH_TO_THE_ZIP.zip', 
                isAsset: false // If you are using a zip from flutter assets folder, specify isAsset field as true and assets path is required as source (not aboslute path e.g. assets/mymap.zip)
            );
